...
# Baseball Catcher
I built software to automatically track and catch a baseball. We caught 17/20 balls—even when they were launched at nearly 60 mph! A video can be found at https://youtu.be/q1axb1CDXnk and an in-depth description is at [BaseballCatcher.pdf](BaseballCatcher/LiveBaseballCatcher/BaseballCatcher.pdf). The work is also published at https://app.readytensor.ai/publications/x7OEKNOwSVM6.
